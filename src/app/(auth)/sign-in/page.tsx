...
export default function SignInForm() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-background text-foreground px-4 py-10">
      <div className="relative w-full max-w-md overflow-hidden rounded-[2rem] border border-border/70 bg-card/95 px-8 py-10 shadow-2xl shadow-black/15 backdrop-blur-xl transition-colors duration-300 mt-8 sm:mt-0">
        {/* Premium Top Left Home Button (With striking initial style) */}
        <div className="absolute left-4 top-5 z-20 sm:left-6 sm:top-6">
          <Link
            href="/"
        ...
        <div className="space-y-4 pb-6 mt-6 border-b border-border/50">
          <p className="text-xs uppercase tracking-[0.35em] text-muted-foreground">
            Softwarence LTD
          </p>
          <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
        ...
        <Form {...form}>
          ...
          >
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 text-base font-semibold transition-transform active:scale-[0.98]"
            >
              {isLoading ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
